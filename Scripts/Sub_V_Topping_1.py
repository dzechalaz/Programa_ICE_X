...
###########################  MAIN  ########################################
    ...
    tcp_speed = 70
    arm.set_position(*[-380.0, 50.2, 135.6, -53.3, 88.4, 115.8], speed=tcp_speed, radius=0.0, wait=False)
    
    arm.set_position(*[-380.0, 50.2, 245.3, -53.3, 88.4, 115.8], speed=tcp_speed, radius=0.0, wait=True)
